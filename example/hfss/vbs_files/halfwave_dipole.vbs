...
oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers", "LocalVariables"), Array("NAME:NewProps", Array("NAME:dipole_height", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", "62.45676208333333mm"))))

oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers", "LocalVariables"), Array("NAME:NewProps", Array("NAME:dipole_gap", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", "1.2491352416666666mm"))))

oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers", "LocalVariables"), Array("NAME:NewProps", Array("NAME:wire_radius", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", "1.2491352416666666mm"))))
...
oEditor.CreateBox Array("NAME:BoxParameters","XPosition:=", "((-(0.06245676208333334+(2*wire_radius)))/2)", "YPosition:=",  _
  "((-(0.06245676208333334+(2*wire_radius)))/2)", "ZPosition:=", "((-(0.06245676208333334+dipole_height))/2)", "XSize:=", "(0.06245676208333334+(2*wire_radius))", "YSize:=", "(0.06245676208333334+(2*wire_radius))", "ZSize:=",  _ 
"(0.06245676208333334+dipole_height)"),Array("NAME:Attributes", "Name:=", "rad_box","Flags:=", "", "Color:=",  _
