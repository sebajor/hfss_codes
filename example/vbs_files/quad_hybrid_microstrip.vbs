...
oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers",  _
 "LocalVariables"), Array("NAME:NewProps", Array("NAME:width50", "PropType:=", "VariableProp", "UserDef:=",  _
 true, "Value:=", "3.050000mm"))))

oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers",  _
 "LocalVariables"), Array("NAME:NewProps", Array("NAME:length50", "PropType:=", "VariableProp", "UserDef:=",  _
 true, "Value:=", "17.100000mm"))))

oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers",  _
 "LocalVariables"), Array("NAME:NewProps", Array("NAME:width35", "PropType:=", "VariableProp", "UserDef:=",  _
 true, "Value:=", "5.300000mm"))))

oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers",  _
 "LocalVariables"), Array("NAME:NewProps", Array("NAME:length35", "PropType:=", "VariableProp", "UserDef:=",  _
 true, "Value:=", "16.700000mm"))))

oDesign.ChangeProperty Array("NAME:AllTabs", Array("NAME:LocalVariableTab", Array("NAME:PropServers",  _
 "LocalVariables"), Array("NAME:NewProps", Array("NAME:feedline_length", "PropType:=", "VariableProp", "UserDef:=",  _
...
oEditor.CreateBox Array("NAME:BoxParameters","XPosition:=", "-(length35+2*(feedline_length-width50)+3*(31.228381041666665mm))/2", "YPosition:=",  _
  "-(length50+2*width35+2*substrate_gap+3*(31.228381041666665mm))/2", "ZPosition:=", "-(2*copper_height+dielectric_height+2*(31.228381041666665mm))/2", "XSize:=", "length35+2*(feedline_length-width50)+3*(31.228381041666665mm)", "YSize:=", "length50+2*width35+2*substrate_gap+3*(31.228381041666665mm)", "ZSize:=",  _ 
